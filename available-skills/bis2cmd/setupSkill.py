...
def main():
 ...
 interactive_configure(root=root,path=config_path(root),title='BISCMD',subtitle='Perfis de acesso ao cliente BIS2',integration='BISCMD',defaults=DEFAULTS,fields=PROFILE_FIELDS)
