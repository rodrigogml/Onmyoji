...
1. Homologar o gateway Telegram e anexos nas instâncias Akuma e Lavelinha: validar o diagnóstico; enviar uma foto, um documento e uma voz; confirmar resposta, typing, retenção e limpeza de staging; executar `/new`; reiniciar o daemon como processo e como serviço; confirmar que cada instância mantém bot, owners, Vault e workspace isolados.
