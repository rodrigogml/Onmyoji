...
Os scripts `setupOnmyoji.py` e `setupSkill.py` formam uma única aplicação de console. Preserve esta linguagem visual em qualquer novo menu ou configuração de skill.
