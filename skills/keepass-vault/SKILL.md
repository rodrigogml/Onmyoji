...
Não inclua a senha mestra, códigos TOTP ou conteúdo de anexos em mensagens, comandos, arquivos versionados ou logs. Configure o perfil com `setupSkill.py`; leia [o contrato](references/contract.md) antes de integrar uma operação e [a configuração](references/configuration.md) ao criar ou revisar perfis.
